...
namespace GeneXus.Programs {
   public class category : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void DrawControls( )
      {
         ...
         GxWebStd.gx_single_line_edit( context, edtCategoryId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A14CategoryId), 4, 0, ".", "")), StringUtil.LTrim( ((edtCategoryId_Enabled!=0) ? context.localUtil.Format( (decimal)(A14CategoryId), "ZZZ9") : context.localUtil.Format( (decimal)(A14CategoryId), "ZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,34);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCategoryId_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtCategoryId_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Category.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtCategoryName_Internalname, StringUtil.RTrim( A15CategoryName), StringUtil.RTrim( context.localUtil.Format( A15CategoryName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,39);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCategoryName_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtCategoryName_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, 0, 0, 0, 1, -1, -1, true, "Name", "left", true, "", "HLP_Category.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void standaloneStartupServer( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            Z15CategoryName = cgiGet( "Z15CategoryName");
      ...
      protected void ZM044( short GX_JID )
      {
         if ( ( GX_JID == 1 ) || ( GX_JID == 0 ) )
         {
            if ( ! IsIns( ) )
            {
               Z15CategoryName = T00043_A15CategoryName[0];
            }
            else
            {
      ...
      {
         /* Using cursor T00044 */
         pr_default.execute(2, new Object[] {n14CategoryId, A14CategoryId});
         if ( (pr_default.getStatus(2) != 101) )
         {
            RcdFound4 = 1;
            A15CategoryName = T00044_A15CategoryName[0];
            AssignAttri("", false, "A15CategoryName", A15CategoryName);
            ZM044( -1) ;
         }
         pr_default.close(2);
      ...
      {
         /* Using cursor T00043 */
         pr_default.execute(1, new Object[] {n14CategoryId, A14CategoryId});
         if ( (pr_default.getStatus(1) != 101) )
         {
            ZM044( 1) ;
            RcdFound4 = 1;
            A14CategoryId = T00043_A14CategoryId[0];
            n14CategoryId = T00043_n14CategoryId[0];
            AssignAttri("", false, "A14CategoryId", StringUtil.LTrimStr( (decimal)(A14CategoryId), 4, 0));
            A15CategoryName = T00043_A15CategoryName[0];
            AssignAttri("", false, "A15CategoryName", A15CategoryName);
            Z14CategoryId = A14CategoryId;
            sMode4 = Gx_mode;
            Gx_mode = "DSP";
      ...
      protected void move_next( )
      {
         RcdFound4 = 0;
         /* Using cursor T00046 */
         pr_default.execute(4, new Object[] {n14CategoryId, A14CategoryId});
         if ( (pr_default.getStatus(4) != 101) )
         {
            while ( (pr_default.getStatus(4) != 101) && ( ( T00046_A14CategoryId[0] < A14CategoryId ) ) )
            {
               pr_default.readNext(4);
            }
            if ( (pr_default.getStatus(4) != 101) && ( ( T00046_A14CategoryId[0] > A14CategoryId ) ) )
            {
               A14CategoryId = T00046_A14CategoryId[0];
               n14CategoryId = T00046_n14CategoryId[0];
               AssignAttri("", false, "A14CategoryId", StringUtil.LTrimStr( (decimal)(A14CategoryId), 4, 0));
               RcdFound4 = 1;
            }
         }
      ...
      protected void move_previous( )
      {
         RcdFound4 = 0;
         /* Using cursor T00047 */
         pr_default.execute(5, new Object[] {n14CategoryId, A14CategoryId});
         if ( (pr_default.getStatus(5) != 101) )
         {
            while ( (pr_default.getStatus(5) != 101) && ( ( T00047_A14CategoryId[0] > A14CategoryId ) ) )
            {
               pr_default.readNext(5);
            }
            if ( (pr_default.getStatus(5) != 101) && ( ( T00047_A14CategoryId[0] < A14CategoryId ) ) )
            {
               A14CategoryId = T00047_A14CategoryId[0];
               n14CategoryId = T00047_n14CategoryId[0];
               AssignAttri("", false, "A14CategoryId", StringUtil.LTrimStr( (decimal)(A14CategoryId), 4, 0));
               RcdFound4 = 1;
            }
         }
      ...
      protected void btn_enter( )
      {
         ...
         else
         {
            if ( RcdFound4 == 1 )
            {
               if ( A14CategoryId != Z14CategoryId )
               {
                  A14CategoryId = Z14CategoryId;
                  n14CategoryId = false;
                  AssignAttri("", false, "A14CategoryId", StringUtil.LTrimStr( (decimal)(A14CategoryId), 4, 0));
      ...
      protected void CheckOptimisticConcurrency044( )
      {
         ...
         {
            /* Using cursor T00042 */
            pr_default.execute(0, new Object[] {n14CategoryId, A14CategoryId});
            ...
            if ( (pr_default.getStatus(0) == 101) || ( StringUtil.StrCmp(Z15CategoryName, T00042_A15CategoryName[0]) != 0 ) )
            {
               if ( StringUtil.StrCmp(Z15CategoryName, T00042_A15CategoryName[0]) != 0 )
               {
                  GXUtil.WriteLog("category:[seudo value changed for attri]"+"CategoryName");
                  GXUtil.WriteLogRaw("Old: ",Z15CategoryName);
                  GXUtil.WriteLogRaw("Current: ",T00042_A15CategoryName[0]);
               }
         ...
         if ( AnyError == 0 )
         {
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  {
                     /* Using cursor T00048 */
                     pr_default.execute(6, new Object[] {A15CategoryName});
                     A14CategoryId = T00048_A14CategoryId[0];
                     n14CategoryId = T00048_n14CategoryId[0];
                     AssignAttri("", false, "A14CategoryId", StringUtil.LTrimStr( (decimal)(A14CategoryId), 4, 0));
                     pr_default.close(6);
         ...
         if ( AnyError == 0 )
         {
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  {
                     /* Using cursor T00049 */
                     pr_default.execute(7, new Object[] {A15CategoryName, n14CategoryId, A14CategoryId});
                     pr_default.close(7);
                     dsDefault.SmartCacheProvider.SetUpdated("Category");
         ...
         if ( AnyError == 0 )
         {
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  pr_default.execute(8, new Object[] {n14CategoryId, A14CategoryId});
                  pr_default.close(8);
                  dsDefault.SmartCacheProvider.SetUpdated("Category");
                  if ( AnyError == 0 )
                  {
      ...
      protected void OnDeleteControls044( )
      {
         ...
         if ( AnyError == 0 )
         {
            ...
            pr_default.execute(9, new Object[] {n14CategoryId, A14CategoryId});
      ...
      public void ScanStart044( )
      {
         ...
         {
            RcdFound4 = 1;
            A14CategoryId = T000412_A14CategoryId[0];
            n14CategoryId = T000412_n14CategoryId[0];
            AssignAttri("", false, "A14CategoryId", StringUtil.LTrimStr( (decimal)(A14CategoryId), 4, 0));
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202361610531451", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202361610531453", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("category.js", "?202361610531453", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("VALID_CATEGORYID","{handler:'Valid_Categoryid',iparms:[{av:'A14CategoryId',fld:'CATEGORYID',pic:'ZZZ9'},{av:'Gx_mode',fld:'vMODE',pic:'@!'}]");
         setEventMetadata("VALID_CATEGORYID",",oparms:[{av:'A15CategoryName',fld:'CATEGORYNAME',pic:''},{av:'Gx_mode',fld:'vMODE',pic:'@!'},{av:'Z14CategoryId'},{av:'Z15CategoryName'},{ctrl:'BTN_DELETE',prop:'Enabled'},{ctrl:'BTN_ENTER',prop:'Enabled'}]}");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         endTrnMsgTxt = "";
         endTrnMsgCod = "";
         T00044_A14CategoryId = new short[1] ;
         T00044_n14CategoryId = new bool[] {false} ;
         T00044_A15CategoryName = new string[] {""} ;
         T00045_A14CategoryId = new short[1] ;
         T00045_n14CategoryId = new bool[] {false} ;
         T00043_A14CategoryId = new short[1] ;
         T00043_n14CategoryId = new bool[] {false} ;
         T00043_A15CategoryName = new string[] {""} ;
         sMode4 = "";
         T00046_A14CategoryId = new short[1] ;
         T00046_n14CategoryId = new bool[] {false} ;
         T00047_A14CategoryId = new short[1] ;
         T00047_n14CategoryId = new bool[] {false} ;
         T00042_A14CategoryId = new short[1] ;
         T00042_n14CategoryId = new bool[] {false} ;
         T00042_A15CategoryName = new string[] {""} ;
         T00048_A14CategoryId = new short[1] ;
         T00048_n14CategoryId = new bool[] {false} ;
         T000411_A16GameId = new short[1] ;
         T000412_A14CategoryId = new short[1] ;
         T000412_n14CategoryId = new bool[] {false} ;
         sDynURL = "";
         FormProcess = "";
         bodyStyle = "";
         ZZ15CategoryName = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.category__default(),
            new Object[][] {
                new Object[] {
               T00042_A14CategoryId, T00042_A15CategoryName
               }
               , new Object[] {
               T00043_A14CategoryId, T00043_A15CategoryName
               }
               , new Object[] {
               T00044_A14CategoryId, T00044_A15CategoryName
               }
               , new Object[] {
               T00045_A14CategoryId
               }
               , new Object[] {
               T00046_A14CategoryId
               }
               , new Object[] {
               T00047_A14CategoryId
               }
               , new Object[] {
               T00048_A14CategoryId
               }
               , new Object[] {
               }
               , new Object[] {
      ...
      private short[] T00044_A14CategoryId ;
      private bool[] T00044_n14CategoryId ;
      private string[] T00044_A15CategoryName ;
      private short[] T00045_A14CategoryId ;
      private bool[] T00045_n14CategoryId ;
      private short[] T00043_A14CategoryId ;
      private bool[] T00043_n14CategoryId ;
      private string[] T00043_A15CategoryName ;
      private short[] T00046_A14CategoryId ;
      private bool[] T00046_n14CategoryId ;
      private short[] T00047_A14CategoryId ;
      private bool[] T00047_n14CategoryId ;
      private short[] T00042_A14CategoryId ;
      private bool[] T00042_n14CategoryId ;
      private string[] T00042_A15CategoryName ;
      private short[] T00048_A14CategoryId ;
      private bool[] T00048_n14CategoryId ;
      private short[] T000411_A16GameId ;
      private short[] T000412_A14CategoryId ;
      private bool[] T000412_n14CategoryId ;
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
             ...
             ,new CursorDef("T000411", "SELECT TOP 1 [GameId] FROM [Game] WHERE [CategoryId] = @CategoryId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000411,1, GxCacheFrequency.OFF ,true,true )
