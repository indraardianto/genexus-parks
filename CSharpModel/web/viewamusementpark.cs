...
namespace GeneXus.Programs {
   public class viewamusementpark : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20236199443183", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void WB0K0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0038"+"", StringUtil.RTrim( WebComp_Employeewc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0046"+"", StringUtil.RTrim( WebComp_Gamewc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
      ...
      protected void RF0K2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            while ( (pr_default.getStatus(0) != 101) )
            {
               ...
               A8AmusementParkName = H000K2_A8AmusementParkName[0];
      ...
      protected void E110K2( )
      {
         ...
         {
            A7AmusementParkId = H000K3_A7AmusementParkId[0];
            A8AmusementParkName = H000K3_A8AmusementParkName[0];
            AssignAttri("", false, "A8AmusementParkName", A8AmusementParkName);
            AV16GXLvl6 = 1;
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "Employee") == 0 ) )
         {
            ...
            if ( StringUtil.Len( WebComp_Employeewc_Component) != 0 )
            {
               ...
               WebComp_Employeewc.componentprepare(new Object[] {(string)"W0038",(string)"",(short)AV12AmusementParkId});
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "Game") == 0 ) )
         {
            ...
            if ( StringUtil.Len( WebComp_Gamewc_Component) != 0 )
            {
               ...
               WebComp_Gamewc.componentprepare(new Object[] {(string)"W0046",(string)"",(short)AV12AmusementParkId});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20236199443211", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewamusementpark.js", "?20236199443211", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      public override void initialize( )
      {
         ...
         H000K2_A8AmusementParkName = new string[] {""} ;
         hsh = "";
         H000K3_A7AmusementParkId = new short[1] ;
         H000K3_A8AmusementParkName = new string[] {""} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewamusementpark__default(),
            new Object[][] {
                new Object[] {
               H000K2_A7AmusementParkId, H000K2_A8AmusementParkName
               }
               , new Object[] {
               H000K3_A7AmusementParkId, H000K3_A8AmusementParkName
               }
            }
         );
      ...
      private string[] H000K2_A8AmusementParkName ;
      private short[] H000K3_A7AmusementParkId ;
      private string[] H000K3_A8AmusementParkName ;
   ...
   public class viewamusementpark__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000K2", "SELECT [AmusementParkId], [AmusementParkName] FROM [AmusementPark] WHERE [AmusementParkId] = @AV12AmusementParkId ORDER BY [AmusementParkId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000K2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H000K3", "SELECT [AmusementParkId], [AmusementParkName] FROM [AmusementPark] WHERE [AmusementParkId] = @AV12AmusementParkId ORDER BY [AmusementParkId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000K3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
