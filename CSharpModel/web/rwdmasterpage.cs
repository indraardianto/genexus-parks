...
namespace GeneXus.Programs {
   public class rwdmasterpage : GXMasterPage, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlCloseForm042( )
      {
         ...
         context.AddJavascriptSource("rwdmasterpage.js", "?2023621845480", false, true);
      ...
      protected void WB040( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblApplicationheader_Internalname, "Amusement Park", "", "", lblApplicationheader_Jsonclick, "'"+""+"'"+",true,"+"'"+"E_MPAGE."+"'", "", "TextBlockHeader", 0, "", 1, 1, 0, 0, "HLP_RwdMasterPage.htm");
            ...
            StyleString = "";
            sImgUrl = (string)(context.GetImagePath( "a19acdb0-c891-4843-98b1-fbdcaab071d7", "", context.GetTheme( )));
      ...
      protected void E12042( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wcrecentlinks_Component) != 0 )
         {
            ...
            WebComp_Wcrecentlinks.componentprepare(new Object[] {(string)"MPW0019",(string)"",(getDataAreaObject() == null ? Form : getDataAreaObject().GetForm()).Caption,Contentholder.Pgmname});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)(getDataAreaObject() == null ? Form : getDataAreaObject().GetForm()).Jscriptsrc.Item(idxLst))), "?2023621845486", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("rwdmasterpage.js", "?2023621845486", false, true);
