...
namespace GeneXus.Programs {
   public class gx0050 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public void execute( out short aP0_pGameId )
      {
         this.AV10pGameId = 0 ;
         executePrivate();
         aP0_pGameId=this.AV10pGameId;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = GetFirstPar( "pGameId");
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid1") == 0 )
            {
               ...
               AV6cGameId = (short)(NumberUtil.Val( GetPar( "cGameId"), "."));
               AV7cGameName = GetPar( "cGameName");
               AV8cAmusementParkId = (short)(NumberUtil.Val( GetPar( "cAmusementParkId"), "."));
               AV9cCategoryId = (short)(NumberUtil.Val( GetPar( "cCategoryId"), "."));
               setAjaxCallMode();
               if ( ! IsValidAjaxCall( true) )
               {
                  GxWebError = 1;
               ...
               GxWebStd.gx_hidden_field( context, "GAMENAMEFILTERCONTAINER_Class", StringUtil.RTrim( divGamenamefiltercontainer_Class));
            ...
            {
               AV10pGameId = (short)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV10pGameId", StringUtil.LTrimStr( (decimal)(AV10pGameId), 4, 0));
            }
            if ( toggleJsOutput )
            {
               if ( context.isSpaRequest( ) )
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202361610531724", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gx0050.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV10pGameId,4,0))}, new string[] {"pGameId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vCGAMEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6cGameId), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "GXH_vCGAMENAME", StringUtil.RTrim( AV7cGameName));
         GxWebStd.gx_hidden_field( context, "GXH_vCAMUSEMENTPARKID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8cAmusementParkId), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "GXH_vCCATEGORYID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV9cCategoryId), 4, 0, ".", "")));
         /* Send saved values. */
         send_integrity_footer_hashes( ) ;
         GxWebStd.gx_hidden_field( context, "nRC_GXsfl_54", StringUtil.LTrim( StringUtil.NToC( (decimal)(nRC_GXsfl_54), 8, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "vPGAMEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10pGameId), 4, 0, ".", "")));
      ...
      {
         return formatLink("gx0050.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV10pGameId,4,0))}, new string[] {"pGameId"})  ;
      }
      ...
      protected void WB0B0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblgameidfilter_Internalname, "Game Id", "", "", lblLblgameidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e110b1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0050.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCgameid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6cGameId), 4, 0, ".", "")), StringUtil.LTrim( ((edtavCgameid_Enabled!=0) ? context.localUtil.Format( (decimal)(AV6cGameId), "ZZZ9") : context.localUtil.Format( (decimal)(AV6cGameId), "ZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCgameid_Jsonclick, 0, "Attribute", "", "", "", "", edtavCgameid_Visible, edtavCgameid_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Gx0050.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divGamenamefiltercontainer_Internalname, 1, 0, "px", 0, "px", divGamenamefiltercontainer_Class, "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblgamenamefilter_Internalname, "Game Name", "", "", lblLblgamenamefilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e120b1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0050.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavCgamename_Internalname, "Game Name", "col-sm-3 AttributeLabel", 0, true, "");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 26,'',false,'" + sGXsfl_54_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavCgamename_Internalname, StringUtil.RTrim( AV7cGameName), StringUtil.RTrim( context.localUtil.Format( AV7cGameName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,26);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCgamename_Jsonclick, 0, "Attribute", "", "", "", "", edtavCgamename_Visible, edtavCgamename_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_Gx0050.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblamusementparkidfilter_Internalname, "Amusement Park Id", "", "", lblLblamusementparkidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e130b1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0050.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCamusementparkid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8cAmusementParkId), 4, 0, ".", "")), StringUtil.LTrim( ((edtavCamusementparkid_Enabled!=0) ? context.localUtil.Format( (decimal)(AV8cAmusementParkId), "ZZZ9") : context.localUtil.Format( (decimal)(AV8cAmusementParkId), "ZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,36);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCamusementparkid_Jsonclick, 0, "Attribute", "", "", "", "", edtavCamusementparkid_Visible, edtavCamusementparkid_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Gx0050.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblcategoryidfilter_Internalname, "Category Id", "", "", lblLblcategoryidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e140b1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0050.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCcategoryid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV9cCategoryId), 4, 0, ".", "")), StringUtil.LTrim( ((edtavCcategoryid_Enabled!=0) ? context.localUtil.Format( (decimal)(AV9cCategoryId), "ZZZ9") : context.localUtil.Format( (decimal)(AV9cCategoryId), "ZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,46);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCcategoryid_Jsonclick, 0, "Attribute", "", "", "", "", edtavCcategoryid_Visible, edtavCcategoryid_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Gx0050.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(54), 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e150b1_client"+"'", TempTags, "", 2, "HLP_Gx0050.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            else
            {
               ...
               Grid1Container.AddColumnProperties(Grid1Column);
               Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
               Grid1Column.AddObjectProperty("Value", StringUtil.RTrim( A17GameName));
               Grid1Column.AddObjectProperty("Link", StringUtil.RTrim( edtGameName_Link));
               Grid1Container.AddColumnProperties(Grid1Column);
               Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
               ...
               Grid1Container.AddColumnProperties(Grid1Column);
               Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
               Grid1Column.AddObjectProperty("Value", context.convertURL( A18GamePhoto));
               Grid1Container.AddColumnProperties(Grid1Column);
      ...
      protected void START0B2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Selection List Game", 0) ;
         }
         context.wjLoc = "";
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 4), "LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) )
                           {
                              ...
                              n14CategoryId = false;
                              A18GamePhoto = cgiGet( edtGamePhoto_Internalname);
                              AssignProp("", false, edtGamePhoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A18GamePhoto)) ? A40000GamePhoto_GXI : context.convertURL( context.PathToRelativeUrl( A18GamePhoto))), !bGXsfl_54_Refreshing);
                              AssignProp("", false, edtGamePhoto_Internalname, "SrcSet", context.GetImageSrcSet( A18GamePhoto), true);
                              sEvtType = StringUtil.Right( sEvt, 1);
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 sEvt = StringUtil.Left( sEvt, (short)(StringUtil.Len( sEvt)-1));
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    if ( ! wbErr )
                                    {
                                       ...
                                       if ( ( context.localUtil.CToN( cgiGet( "GXH_vCGAMEID"), ".", ",") != Convert.ToDecimal( AV6cGameId )) )
                                       {
                                          Rfr0gs = true;
                                       }
                                       /* Set Refresh If Cgamename Changed */
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vCGAMENAME"), AV7cGameName) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       /* Set Refresh If Camusementparkid Changed */
                                       if ( ( context.localUtil.CToN( cgiGet( "GXH_vCAMUSEMENTPARKID"), ".", ",") != Convert.ToDecimal( AV8cAmusementParkId )) )
                                       {
                                          Rfr0gs = true;
                                       }
                                       /* Set Refresh If Ccategoryid Changed */
                                       if ( ( context.localUtil.CToN( cgiGet( "GXH_vCCATEGORYID"), ".", ",") != Convert.ToDecimal( AV9cCategoryId )) )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_GAMEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(A16GameId), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "GAMEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A16GameId), 4, 0, ".", "")));
      }
      ...
      protected void RF0B2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV7cGameName = StringUtil.PadR( StringUtil.RTrim( AV7cGameName), 50, "%");
            /* Using cursor H000B2 */
            pr_default.execute(0, new Object[] {AV6cGameId, lV7cGameName, AV8cAmusementParkId, AV9cCategoryId, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_54_idx = 1;
            sGXsfl_54_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_54_idx), 4, 0), 4, "0");
            SubsflControlProps_542( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( GRID1_nCurrentRecord < subGrid1_fnc_Recordsperpage( ) ) ) )
            {
               ...
               AssignProp("", false, edtGamePhoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A18GamePhoto)) ? A40000GamePhoto_GXI : context.convertURL( context.PathToRelativeUrl( A18GamePhoto))), !bGXsfl_54_Refreshing);
               AssignProp("", false, edtGamePhoto_Internalname, "SrcSet", context.GetImageSrcSet( A18GamePhoto), true);
               A14CategoryId = H000B2_A14CategoryId[0];
               n14CategoryId = H000B2_n14CategoryId[0];
               A7AmusementParkId = H000B2_A7AmusementParkId[0];
               A17GameName = H000B2_A17GameName[0];
               A16GameId = H000B2_A16GameId[0];
               A18GamePhoto = H000B2_A18GamePhoto[0];
               AssignProp("", false, edtGamePhoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A18GamePhoto)) ? A40000GamePhoto_GXI : context.convertURL( context.PathToRelativeUrl( A18GamePhoto))), !bGXsfl_54_Refreshing);
               AssignProp("", false, edtGamePhoto_Internalname, "SrcSet", context.GetImageSrcSet( A18GamePhoto), true);
               /* Execute user event: Load */
               E170B2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_GAMEID"+"_"+sGXsfl_54_idx, GetSecureSignedToken( sGXsfl_54_idx, context.localUtil.Format( (decimal)(A16GameId), "ZZZ9"), context));
      }
      ...
      protected int subGrid1_fnc_Recordcount( )
      {
         ...
         lV7cGameName = StringUtil.PadR( StringUtil.RTrim( AV7cGameName), 50, "%");
         /* Using cursor H000B3 */
         pr_default.execute(1, new Object[] {AV6cGameId, lV7cGameName, AV8cAmusementParkId, AV9cCategoryId});
      ...
      protected void STRUP0B0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            if ( ( ( context.localUtil.CToN( cgiGet( edtavCgameid_Internalname), ".", ",") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavCgameid_Internalname), ".", ",") > Convert.ToDecimal( 9999 )) ) )
            {
               ...
               wbErr = true;
               AV6cGameId = 0;
               AssignAttri("", false, "AV6cGameId", StringUtil.LTrimStr( (decimal)(AV6cGameId), 4, 0));
            }
            else
            {
               AV6cGameId = (short)(context.localUtil.CToN( cgiGet( edtavCgameid_Internalname), ".", ","));
               AssignAttri("", false, "AV6cGameId", StringUtil.LTrimStr( (decimal)(AV6cGameId), 4, 0));
            }
            AV7cGameName = cgiGet( edtavCgamename_Internalname);
            AssignAttri("", false, "AV7cGameName", AV7cGameName);
            if ( ( ( context.localUtil.CToN( cgiGet( edtavCamusementparkid_Internalname), ".", ",") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavCamusementparkid_Internalname), ".", ",") > Convert.ToDecimal( 9999 )) ) )
            {
               ...
               AssignAttri("", false, "GX_FocusControl", GX_FocusControl);
               wbErr = true;
               AV8cAmusementParkId = 0;
               AssignAttri("", false, "AV8cAmusementParkId", StringUtil.LTrimStr( (decimal)(AV8cAmusementParkId), 4, 0));
            }
            else
            {
               AV8cAmusementParkId = (short)(context.localUtil.CToN( cgiGet( edtavCamusementparkid_Internalname), ".", ","));
               AssignAttri("", false, "AV8cAmusementParkId", StringUtil.LTrimStr( (decimal)(AV8cAmusementParkId), 4, 0));
            }
            if ( ( ( context.localUtil.CToN( cgiGet( edtavCcategoryid_Internalname), ".", ",") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavCcategoryid_Internalname), ".", ",") > Convert.ToDecimal( 9999 )) ) )
            {
               ...
               wbErr = true;
               AV9cCategoryId = 0;
               AssignAttri("", false, "AV9cCategoryId", StringUtil.LTrimStr( (decimal)(AV9cCategoryId), 4, 0));
            }
            else
            {
               AV9cCategoryId = (short)(context.localUtil.CToN( cgiGet( edtavCcategoryid_Internalname), ".", ","));
               AssignAttri("", false, "AV9cCategoryId", StringUtil.LTrimStr( (decimal)(AV9cCategoryId), 4, 0));
            }
      ...
      protected void E160B2( )
      {
         /* Start Routine */
         returnInSub = false;
         Form.Caption = StringUtil.Format( "Selection List %1", "Game", "", "", "", "", "", "", "", "");
      ...
      protected void E180B2( )
      {
         /* Enter Routine */
         returnInSub = false;
         AV10pGameId = A16GameId;
         AssignAttri("", false, "AV10pGameId", StringUtil.LTrimStr( (decimal)(AV10pGameId), 4, 0));
         context.setWebReturnParms(new Object[] {(short)AV10pGameId});
         context.setWebReturnParmsMetadata(new Object[] {"AV10pGameId"});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10pGameId = Convert.ToInt16(getParm(obj,0));
         AssignAttri("", false, "AV10pGameId", StringUtil.LTrimStr( (decimal)(AV10pGameId), 4, 0));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202361610531762", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx0050.js", "?202361610531762", false, true);
      ...
      protected void sendrow_542( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_54_idx <= subGrid1_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            edtavLinkselection_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A16GameId), 4, 0, ".", "")))+"'"+"]);";
            ...
            edtGameName_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A16GameId), 4, 0, ".", "")))+"'"+"]);";
            AssignProp("", false, edtGameName_Internalname, "Link", edtGameName_Link, !bGXsfl_54_Refreshing);
            Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtGameName_Internalname,StringUtil.RTrim( A17GameName),(string)"",(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)edtGameName_Link,(string)"",(string)"",(string)"",(string)edtGameName_Jsonclick,(short)0,(string)"DescriptionAttribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)50,(short)0,(short)0,(short)54,(short)1,(short)-1,(short)-1,(bool)true,(string)"Name",(string)"left",(bool)true,(string)""});
            /* Subfile cell */
            if ( Grid1Container.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
            ...
            Grid1Row.AddColumnProperties("bitmap", 1, isAjaxCallMode( ), new Object[] {(string)edtGamePhoto_Internalname,(string)sImgUrl,(string)"",(string)"",(string)"",context.GetTheme( ),(short)-1,(short)0,(string)"",(string)"",(short)1,(short)-1,(short)0,(string)"px",(short)0,(string)"px",(short)0,(short)0,(short)0,(string)"",(string)"",(string)StyleString,(string)ClassString,(string)"WWColumn OptionalColumn",(string)"",(string)"",(string)"",(string)"",(string)"",(string)"",(short)1,(bool)A18GamePhoto_IsBlob,(bool)true,context.GetImageSrcSet( sImgUrl)});
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Selection List Game";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("ENTER","{handler:'E180B2',iparms:[{av:'A16GameId',fld:'GAMEID',pic:'ZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         H000B2_A14CategoryId = new short[1] ;
         H000B2_n14CategoryId = new bool[] {false} ;
         H000B2_A7AmusementParkId = new short[1] ;
         H000B2_A17GameName = new string[] {""} ;
         H000B2_A16GameId = new short[1] ;
         H000B2_A18GamePhoto = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx0050__default(),
            new Object[][] {
                new Object[] {
               H000B2_A40000GamePhoto_GXI, H000B2_A14CategoryId, H000B2_n14CategoryId, H000B2_A7AmusementParkId, H000B2_A17GameName, H000B2_A16GameId, H000B2_A18GamePhoto
               }
               , new Object[] {
      ...
      private short[] H000B2_A14CategoryId ;
      private bool[] H000B2_n14CategoryId ;
      private short[] H000B2_A7AmusementParkId ;
      private string[] H000B2_A17GameName ;
      private short[] H000B2_A16GameId ;
      private string[] H000B2_A18GamePhoto ;
      private long[] H000B3_AGRID1_nRecordCount ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private short aP0_pGameId ;
   ...
   public class gx0050__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short AV6cGameId )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " [GamePhoto_GXI], [CategoryId], [AmusementParkId], [GameName], [GameId], [GamePhoto]";
         sFromString = " FROM [Game]";
         sOrderString = "";
         AddWhere(sWhereString, "([GameId] >= @AV6cGameId)");
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV7cGameName)) )
         {
            AddWhere(sWhereString, "([GameName] like @lV7cGameName)");
         }
         else
         {
            GXv_int1[1] = 1;
         ...
         {
            AddWhere(sWhereString, "([AmusementParkId] >= @AV8cAmusementParkId)");
         }
         else
         {
            GXv_int1[2] = 1;
         ...
         if ( ! (0==AV9cCategoryId) )
         {
            AddWhere(sWhereString, "([CategoryId] >= @AV9cCategoryId)");
         }
         else
         {
            GXv_int1[3] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H000B2(context, (string)dynConstraints[0] , (short)dynConstraints[1] , (short)dynConstraints[2] , (string)dynConstraints[3] , (short)dynConstraints[4] , (short)dynConstraints[5] , (short)dynConstraints[6] );
               case 1 :
                     return conditional_H000B3(context, (string)dynConstraints[0] , (short)dynConstraints[1] , (short)dynConstraints[2] , (string)dynConstraints[3] , (short)dynConstraints[4] , (short)dynConstraints[5] , (short)dynConstraints[6] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV6cGameId",GXType.Int16,4,0) ,
          new ParDef("@lV7cGameName",GXType.NChar,50,0) ,
          new ParDef("@AV8cAmusementParkId",GXType.Int16,4,0) ,
          new ParDef("@AV9cCategoryId",GXType.Int16,4,0) ,
          ...
          def= new CursorDef[] {
              new CursorDef("H000B2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000B2,1, GxCacheFrequency.OFF ,false,false )
