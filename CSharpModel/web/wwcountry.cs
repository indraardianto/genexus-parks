...
namespace GeneXus.Programs {
   public class wwcountry : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20236199475477", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_COUNTRYID"+"_"+sGXsfl_25_idx, GetSecureSignedToken( sGXsfl_25_idx, context.localUtil.Format( (decimal)(A12CountryId), "ZZZ9"), context));
      }
      ...
      private void E140H2( )
      {
         /* Grid_Load Routine */
         returnInSub = false;
         edtavUpdate_Link = formatLink("country.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(StringUtil.LTrimStr(A12CountryId,4,0))}, new string[] {"Mode","CountryId"}) ;
         edtavDelete_Link = formatLink("country.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.LTrimStr(A12CountryId,4,0))}, new string[] {"Mode","CountryId"}) ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2023619947555", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwcountry.js", "?2023619947555", false, true);
         }
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E140H2',iparms:[{av:'A12CountryId',fld:'COUNTRYID',pic:'ZZZ9',hsh:true}]");
         ...
         setEventMetadata("'DOINSERT'","{handler:'E110H2',iparms:[{av:'A12CountryId',fld:'COUNTRYID',pic:'ZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwcountry__default(),
            new Object[][] {
                new Object[] {
               H000H2_A13CountryName, H000H2_A12CountryId
               }
               , new Object[] {
